...
PKG_SUPPORTED_OPTIONS=		debug jre-jce x11 static-libstdcpp jdk-bundled-zlib
...
.include "../../../pkgsrc/mk/bsd.options.mk"
...
DEPENDS+=		dejavu-ttf-[0-9]*:../../../pkgsrc/fonts/dejavu-ttf
#DEPENDS+=		ja-sazanami-ttf-[0-9]*:../../../pkgsrc/fonts/ja-sazanami-ttf
#DEPENDS+=		baekmuk-ttf-[0-9]*:../../../pkgsrc/fonts/baekmuk-ttf
.include "../../../pkgsrc/x11/libXi/buildlink3.mk"
.include "../../../pkgsrc/x11/libX11/buildlink3.mk"
.include "../../../pkgsrc/x11/libXext/buildlink3.mk"
BUILDLINK_DEPMETHOD.libXt?=	build
.include "../../../pkgsrc/x11/libXt/buildlink3.mk"
.include "../../../pkgsrc/x11/libXrender/buildlink3.mk"
.include "../../../pkgsrc/x11/libXtst/buildlink3.mk"
.include "../../../pkgsrc/x11/libXrandr/buildlink3.mk"
.else
CONFIGURE_ARGS+=	--x-includes=${X11BASE}/include
CONFIGURE_ARGS+=	--x-libraries=${X11BASE}/lib
...
BUILD_VARIANT=		zero
.include "../../../pkgsrc/devel/libffi/buildlink3.mk"
...
.include "../../../pkgsrc/devel/zlib/buildlink3.mk"
.endif
